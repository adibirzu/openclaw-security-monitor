...
| CVE | Version compliance | Minimum v2026.5.26 enforcement |
...
1. **Update OpenClaw to v2026.5.26+** (current safe baseline; June 2026 advisories are fixed in v2026.5.26)
...
28. **Update to v2026.5.26+** for the current safe baseline, including the March, April, and June 2026 advisory waves
